...
%The ETFSI method has been used extensively in the literature to calculate properties of the inner crust of NS, using Skyrme forces~\cite{onsi2008semi,pearsonInnerCrustNeutron2012,pearson2015role,pearsonUnifiedEquationsState2018,pearsonErratumUnifiedEquations2019}, and more recently with finite-range Gogny forces~\cite{mondalStructureCompositionInner2020}.
%Nuclear matter within the inner crust is expected to have superfluid properties~\cite{dean2003pairing}, and consequently in
